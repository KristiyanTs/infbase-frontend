<template>
  <div>
    ...
    <base-input :disabled="report.completed" :required="true" label="Number of students" v-model="report.students"></base-input>
    ...
    <base-button v-if="report.completed" type="success" class="float-right mt-5" @click="goToReports">Back</base-button>
    <base-button v-else type="primary" class="float-right mt-5" @click="submitReport">Submit</base-button>
  </div>
</template>
<script>
export default {
